...
async def _(event):
    ...
    if input_str == "hack":
        ...
        animation_chars = [
            ...
            "`Hacking... 84%\n█████████████████████▒▒▒▒ `",
            "`Hacking... 100%\n█████████HACKED███████████ `",
            "`Targeted Account Hacked...\n\nPay 999$ and a Plate of Biriyani To this Nigga To Remove This Hack`"]
...
async def _(event):
    ...
    if input_str == "chod":
        ...
        animation_chars = [
            "`Randi Founded`",
            "`Your Mom Is Going To Fucked By Jonny Baba\n` ",
